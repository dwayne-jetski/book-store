...
function AddBook(){
    ...
    function displaySuccess(){
        ...
        return(
            <div>
                <br/><br/><br/>
                <h3>{values.title} was added successfully!</h3>
                <Button variant="info" onClick={rerenderAddBookForm}>Click to add another book</Button>
            </div>
        )
    }
    ...
    return(
        ...
        <React.Fragment>
            ...
            {(bookAddedSuccessfuly) ? displaySuccess() : addBookField()}
